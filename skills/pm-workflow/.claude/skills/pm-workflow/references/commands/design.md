...
如果当前环境无法启动界面设计子 agent,必须停止界面与原型设计,不生成或修改 `docs/ui-design-brief.md`、`docs/ui-design-tokens.md`、`docs/ui-build-tasks.md`、`docs/ui-design.md`、`docs/handoff-ui.md`、`prototype/` 和 `docs/workflow-state.json`,并提示用户在支持项目子 agent 调度的 CLI 中打开当前工作室目录后重试。
